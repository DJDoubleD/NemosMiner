...
Try {
    $Request = get-content ((split-path -parent (get-item $script:MyInvocation.MyCommand.Path).Directory) + "\BrainPlus\ZergPoolPlusTopCoin\ZergPoolPlusTopCoin.json") | ConvertFrom-Json
